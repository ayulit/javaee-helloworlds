...
public class EntityManagerFactoriesConfig {
	...
	public LocalContainerEntityManagerFactoryBean getEntityManagerFactory() {
		...
		emf.setPackagesToScan(new String[] { "com.ayulit.base" });  // Needed for find classes annotated by ORM annotations. We don't need to use persisitence.xml then (works from Spring 3.1)
